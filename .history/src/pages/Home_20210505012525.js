...
function Home() {
  ...
  let newArr1 = arrayOfKeys.sort();
  let newArrFirstValue = arrayOfKeys[1];
  console.log(newArrFirstValue);
  // var newAraj = arrayOfKeys.split(" ");
  //  keys

  var sortedArray = arrayOfKeys.sort(function (a, b) {
    if (a > b) return 1;
    if (a < b) return -1;
    return 0;
  });
  console.log(arrayOfKeys + " not sorted");
  // console.log(localStorage.key[newAraj[0]]);
